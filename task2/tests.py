...
Я в своих решениях руководствовался следующим правилом - обычно существительное, то есть само название вида/рода стоит
последним словом, поэтому мы первую букву этого слова и изменяем в словаре, точнее, значение для нее.
"""
