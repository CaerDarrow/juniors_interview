...
tests2 = [
    ...
    {'intervals': {'lesson': [1594663200, 1594666800],
             'pupil': [1594663340, 1594663389, 1594663390, 1594663395, 1594663396, 1594663398],
...
class TestSolution(unittest.TestCase):
    ...
    def test_with_odd_list_pupil(self):
        self.assertRaises(ListOddLength, appearance, tests2[0]['intervals'])

    def test_with_odd_list_tutor(self):
        self.assertRaises(ListOddLength, appearance, tests2[0]['intervals'])
